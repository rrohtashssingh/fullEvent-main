...
const TopEventbg = () => {
  return (
    ...
    <>
      ...
      <Image
        src={EventBg}
        className="sm:h-dvh h-[60vh] mb-16 relative brightness-[0.3] w-full"
        alt=""
        width="100"
        height="100" />
      ...
      <div className=" max-w-2xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white z-20 flex justify-center flex-col text-center items-center">
        ...
        <div className="explore_event_btn -translate-x-12" >
          <button className="absolute mt-4 font-semibold cursor-pointer bg-purple-500 px-3 py-2 hover:bg-purple-600 rounded-lg ">
            explore
          </button>
        </div>
